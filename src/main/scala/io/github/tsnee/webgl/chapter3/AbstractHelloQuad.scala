...
abstract class AbstractHelloQuad(arrayDrawingMode: Int, suffix: String = "") extends Exercise:
  override def label: String = s"HelloQuad$suffix"
...
"""
  ...
  private def run(
    ...
    val vertices     =
      Float32Array(js.Array(-0.5f, 0.5f, -0.5f, -0.5f, 0.5f, 0.5f, 0.5f, -0.5f))
