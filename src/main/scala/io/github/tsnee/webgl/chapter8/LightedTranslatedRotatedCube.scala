...
object LightedTranslatedRotatedCube extends Exercise:
  override val label: String = "LightedTranslatedRotatedCube"
...
"""
  ...
  private def run(
    ...
    val modelMatrix     = Matrix4.setTranslate(0f, 0.9f, 0f).rotate(90f, 0f, 0f, 1f)
    ...
    val mvpMatrix       = Matrix4
      ...
      .lookAt(eyeX = 3f, eyeY = 3f, eyeZ = 7f, atX = 0f, atY = 0f, atZ = 0f, upX = 0f, upY = 1f, upZ = 0f) * modelMatrix
