...
"""
  ...
  private def useWebgl(
    ...
    val viewProjMatrixFromLight = Matrix4.setPerspective(70, OffscreenWidth.toFloat / OffscreenHeight, 1, 200)
  ...
  private def initFramebufferObject(gl: WebGLRenderingContext): FramebufferWrapper =
    ...
    // Not mentioned in the book, but the code won't work without the next two statements
    gl.texParameteri(
