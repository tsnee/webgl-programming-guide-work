...
object OrthoViewHalfSize extends Exercise:
  override val label: String = "OrthoView_halfSize"
...
"""
  ...
  def initialize(canvas: Canvas): Unit =
    Array(-0.5f, 0.5f, -0.5f, 0.5f, 0f, 0.5f).copyToArray(gProjectionMatrixValues)
